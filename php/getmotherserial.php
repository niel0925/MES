...
session_start();
	...
	$countqty = Mother::getCountMotherqty($account,$serialno[0]);
			...
			$Station->StationDetails($account,$Serial->getCurtStation());
			...
			echo 'success_'.$_GET['serialno']."_".$Serial->getPartNo()."_".$type."_".$ModelRoute->getnextstage1($account,$Serial->getPartNo(),$ModelRoute->getFlowsequence())."_".$Serial->getStatus()."_".$Serial-> getLastUpdatedBy()."_".$countqty;
			}else{
