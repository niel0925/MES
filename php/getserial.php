...
session_start();
	...
	$exist = Card::checkExist($account,$serialno[0]);
			...
			echo 'success_'.$_GET['serialno']."_".$Serial->getPartNo()."_".$type."_".$ModelRoute->getnextstage1($account,$Serial->getPartNo(),$ModelRoute->getFlowsequence())."_".$Serial->getStatus()."_".$Serial-> getLastUpdatedBy();
			}else{
