...
session_start();
	...
	if ($exist == 'true') {
			...
			$Partsrecords->setThawdate($thawdate);
			$Partsrecords->setExp
			$Partsrecords->didInfo($did);

		echo 'ok_'.$Partsrecords->getPartno()."_".$Partsrecords->getDescription()."_".$Partsrecords->getIPN()."_".$Partsrecords->getMaker()."_".$Partsrecords->getMakercode()."_".$Partsrecords->getLotno()."_".$Partsrecords->getCompotype()."_".$Partsrecords->getQty()."_".$Partsrecords->getStatus()."_".$Partsrecords->getPrintedby()."_".$Partsrecords->getInvoiceno()."_".$Partsrecords->getPrinteddate.;
