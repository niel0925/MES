...
echo 'success_'.$serial1.'_'.$resultqty1.'_'.$serial2.'_'.$resultqty2.'_'.$motherserial.'_'.$qty4.'_'.$partno1.'motherqty1:_'.$motherqty1.'a_'.$a;
return;
