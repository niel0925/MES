...
echo 'success_'.$serial1.'_'.$resultqty1.'_'.$serial2.'_'.$resultqty2.'_'.$serial3.'_'.$resultqty3.'_'.$motherserial.'_'.$qty4.'_'.$isvalidnextstage.'_'.$account.'_'.$model.'_'.$curr.'_'.$next;
return;
