...
session_start();
	...
	if(intval($Quantity) == intval($count) + 1){
		...
		echo 'true_'.$_GET['serialno']."_".$counter."_".$Batch->getPartNo()."_".$Batch->getCurrquantity()."_GOOD";

	}else{
		$counter = intval($count) + 1;
		echo 'false_'.$_GET['serialno']."_".$counter."_".$Batch->getPartNo()."_".$Batch->getCurrquantity()."_GOOD";	
	 }
	}
