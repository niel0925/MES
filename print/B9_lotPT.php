...
$qty = Batch::getRefBatchQty($account,$ref);
    ?>
...
<body>
  ...
  <div id="label" style="left:0px;width:382px;height:257px;background:url(../assets/image/B9_lot.png);">
      ...
      12px;background-color:white;color:black;">ION-IONICS-VP</div>
  ...
  <table style="">
    ...
    <?php 
      ...
      $serials = Batch::getAllLotSerialRef($account,$lot,$ref);
      for($i=0;$i<count($serials);$i++){
     ?>
      <tr style="font-size:12px;">
        <td><?php echo strtoupper($serials[$i]->getBatchno()); ?></td>
