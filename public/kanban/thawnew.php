...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center" role="document">
            <div class="modal-content">
                <div class="modal-header">
                     ...
                     <h4 class="modal-title" id="myModalLabel">Enter Machine ID</h4>
     ...
     <div class="col-md-7">
      <input type="text" class="form-control" id="txtMachine" name="txtMachine" onkeyup="if (event.keyCode == 13)  return false; " autofocus>
        </div>
</div>
                </div>
...
<br />
  <div class="row">
     ...
     <div class="col-md-7">
      <input type="text" class="form-control" id="txtMachineId" name="txtMachineId" readonly="">
        </div>
</div>
<br />
<div class="row">
  ...
  $("#txtdid").focus();
       ...
       $("#btnreset").click(function() {
                  ...
                  document.getElementById("error2").setAttribute("hidden","");
                   ...
                   $("#txtdid").focus()
                   document.getElementById("txtMachineId").value = '';
   ...
   if (document.getElementById("txtdid").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
             ...
             xmlhttp.open("GET", "../php/kanban_thawupdatenew.php?DID="+document.getElementById("txtdid").value+"&EndDate="+document.getElementById("txtend").value+"&StartDate="+document.getElementById("txtstart").value+"&machineId="+document.getElementById("txtMachineId").value, true);
            xmlhttp.send();
      ...
      if (document.getElementById("txtdid").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
             ...
             xmlhttp.open("GET", "../php/kanban_thawpwbnew.php?DID="+document.getElementById("txtdid").value, true);
            xmlhttp.send();
          }
    ...
    $('#txtMachine').keyup(function(event){
            var keycode = (event.keyCode ? event.keyCode : event.which);
            var exist = false;

          if(keycode == '13'){

            document.getElementById("txtMachineId").value = document.getElementById("txtMachine").value;
