<main class="mdl-layout__content mdl-color--grey-100">
  <h2 class="text-center">PREVENTIVE MAINTENANCE</h2>
  <div class="mdl-grid demo-content">
    ...
    <input type="hidden" name="process" id="process" hidden="">
        <div class="col-md-6">
            ...
            <div class="col-md-8">
              <select class="form-control" name=plantNoEndorser id="plantNoEndorser" disabled="">
                <option></option>
...
$(document).ready(function(){
  ...
  $('#btngood').click(function(){
      ...
      var xmlhttp = new XMLHttpRequest();
          ...
          xmlhttp.open("GET","../php/feeder_pmgood.php?feederId="+document.getElementById("feederId").value+"&process="+document.getElementById("process").value,true)
          xmlhttp.send();
    ...
    $('#btnreject').click(function(){
      ...
      var xmlhttp = new XMLHttpRequest();
          ...
          xmlhttp.open("GET","../php/feeder_pmreject.php?feederId="+document.getElementById("feederId").value,true)
          xmlhttp.send();
      ...
      if (keycode =='13'){
        ...
        if(document.getElementById("feederId").value == ''){
          ...
          xmlhttp.onreadystatechange = function(){
            if (this.readyState == 4 && this.status == 200) {
              ...
              if(res[0].trim() == 'ok'){
                ...
                document.getElementById("sequence").value = res[7];
                document.getElementById("process").value = res[8];
          ...
          xmlhttp.open("GET","../php/feeder_pmkeypress.php?feederId="+document.getElementById("feederId").value+"&feederType="+document.getElementById("feederType").value+"&feederSize="+document.getElementById("feederSize").value+"&plantNoFeeder="+document.getElementById("plantNoFeeder").value+"&plantNoEndorser="+document.getElementById("plantNoEndorser").value+"&description="+document.getElementById("description").value+"&sequence="+document.getElementById("sequence").value+"&process="+document.getElementById("process").value,true) 
          xmlhttp.send();
        }
      }
    }); 
