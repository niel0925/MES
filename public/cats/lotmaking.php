...
<option value ='<?php echo $SelectModel[$i]->getModel(); ?>' <?php if($cmbmodel==$SelectModel[$i]->getModel()) {echo "selected";} ?> ><?php echo $SelectModel[$i]->getModel(); ?></option>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="RQuantity" name="RQuantity" onkeypress="if (event.keyCode == 13)  return false;">
...
//           }
      ...
      /*         alert(result);*/
            ...
            xmlhttp.open("GET", "../php/lotformat.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value + "&station=" + document.getElementById("ScmbStation").value+"&RQuantity=" + document.getElementById("RQuantity").value, true);
            xmlhttp.send();
          ...
          if(keycode == '13'){
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               //alert(result);
                 if(res[0] == 'true'){
                   ...
                   document.getElementById("txtRev").value = res[2];
            ...
            xmlhttp.open("GET", "../php/lotserial.php?serialno=" + document.getElementById("StextSerial").value + "&model=" + document.getElementById("ScmbModel").value + "&station=" + document.getElementById("ScmbStation").value, true);
            xmlhttp.send();
     ...
     $('#RQuantity').keyup(function(event){
        ...
        $('#StextSerial').focus();
          ...
          $( "#btnGood" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/addserialtolot.php?serialno=" + document.getElementById("StextSerial").value+"&lotno="+ document.getElementById("StextLotNo").value +"&station=" + document.getElementById("ScmbStation").value+"&RQuantity=" + document.getElementById("RQuantity").value, true);
            xmlhttp.send();
           ...
           $( "#btnlot" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/lotclose.php?lotno="+ document.getElementById("StextLotNo").value +"&station=" + document.getElementById("ScmbStation").value+"&LotQuantity=" + document.getElementById("LotQuantity").value+"&modelno=" + document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
