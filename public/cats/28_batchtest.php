...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
  ...
  <!--  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> Serial <b id="Serial_Error1" name="Serial_Error1"></b> is not exist!</div>
    ...
    <div id = "didnotexist" class="alert alert-danger alert-dismissible" role="alert" hidden>
  <!--  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> DID <b id="Serial_Error7" name="Serial_Error7"></b> is not exist!</div>

     <div id = "didnotissued" class="alert alert-danger alert-dismissible" role="alert" hidden>
  <!--  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> DID <b id="Serial_Error8" name="Serial_Error8"></b> is not yet issued!</div>
...
<option value ='<?php echo $SelectModel[$i]->getModel(); ?>' <?php if($cmbmodel==$SelectModel[$i]->getModel()) {echo "selected";} ?> ><?php echo $SelectModel[$i]->getModel(); ?> </option>
  ...
  <div class="form-group">
      <label for="pwd">DID:</label>
      <input type="text" class="form-control" id="StextDID" name="StextDID" onkeypress="if (event.keyCode == 13)  return false;" disabled >
    </div>

       <div class="row" >o
                    <div class="col-md-12" align="right">
                       <input type="checkbox" style="zoom:1.5;" name="chkboxRej" id="chkboxRej" value="REJECT" disabled> <label for="pwd">REJECT</label>    
                    </div>
  ...
  <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-9">
                            <input type="text" id="txtDID" name="txtDID" value="<?php echo $txtdid;?>" class="form-control input-sm" <?php echo $readonly; ?>><br>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-3">
                  ...
                  <div class="panel-body">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                         ...
                         <div class="col-md-5">
                            <input id="txtRejectQty" type="number" min="1" name="txtRejectQty" class="form-control input-sm" disabled><br>
                         </div>
                         <div class="col-md-4">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
      ...
      if (document.getElementById("ScmbModel").value == '') { 
          ...
          if (document.getElementById("ScmbStation").value == '') {
          ...
          }else if (document.getElementById("ScmbStation").value == '005: Underfill Inspection'){
              document.getElementById("ScmbLine").disabled = true;
              document.getElementById("StextDID").disabled = false;
                $('#StextDID').focus();
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               if(result == 1){
                ...
                $('#ScmbLine').focus();
                document.getElementById("chkboxRej").disabled = false;
                document.getElementById("StextSerial").disabled = true;
                document.getElementById("StextSerial").value = '';
                document.getElementById("txtModel").value = '';
                document.getElementById("txtRev").value = '';
      ...
      if (document.getElementById("StextDID").value == '') {     
          return;
        }else {
          ...
          document.getElementById("StextSerial").disabled = false;
          document.getElementById("didnotexist").setAttribute("hidden","");
          document.getElementById("didnotissued").setAttribute("hidden","");
          document.getElementById("StextSerial").focus();

                }else if(res[0].trim() == 'didnotissued'){

          document.getElementById("StextDID").value = '';        
          document.getElementById("StextSerial").disabled = true;
          document.getElementById("didnotexist").setAttribute("hidden","");
          document.getElementById("didnotissued").setAttribute("hidden","");
          document.getElementById("didnotissued").removeAttribute("hidden");

          document.getElementById("StextDID").focus();
          document.getElementById("StextDID").select();
          ...
          document.getElementById("didnotissued").setAttribute("hidden","");
          document.getElementById("didnotexist").setAttribute("hidden","");
          document.getElementById("didnotexist").removeAttribute("hidden");
          ...
          document.getElementById("StextDID").select();      
            ...
            xmlhttp.open("GET", "../php/28_didbatchcheck.php?did=" + document.getElementById("StextDID").value, true);
            xmlhttp.send();
         ...
         $( "#btnGood" ).click(function() {
          ...
          if (document.getElementById("ScmbStation").value == '005: Underfill Inspection'){
          ...
          var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "../php/28_underfilltesting.php?serialno=" + document.getElementById("StextSerial").value +"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value+"&Qty="+ document.getElementById("txtQty").value+"&DID="+ document.getElementById("StextDID").value, true);
            xmlhttp.send();
          ...
          var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "../php/updatebatch.php?serialno=" + document.getElementById("StextSerial").value +"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value+"&Qty="+ document.getElementById("txtQty").value, true);
            xmlhttp.send();
            }
        });
          ...
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               if( res[0]  == 'success'){
                ...
                document.getElementById("txtDID").value = res[8];
              ...
              xmlhttp.open("GET", "../php/28_getbatchserial.php?serialno=" + document.getElementById("StextSerial").value +"&model=" + document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
          }
...
if (document.getElementById("StextSerial").value == '') { 
     ...
     var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "../php/batch_rejectstatus.php?serialno=" + document.getElementById("StextSerial").value +"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          }
        ...
        tblcount = $('#tbldetails tr').length;
          ...
          $( "#btnRejDone" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/28_addrejectbatchtesting.php?serialno=" + document.getElementById("StextSerial").value +"&hrejectcat="+JSON.stringify(hrejectcat)+"&hrejectcode="+JSON.stringify(hrejectcode)+"&hlocation="+JSON.stringify(hlocation)+"&hRejectQty="+JSON.stringify(hRejectQty)+"&hdetails="+JSON.stringify(hdetails)+"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value+"&Qty="+ document.getElementById("txtQty").value+"&model="+ document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
