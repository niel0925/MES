...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
 ...
 <!--   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   ...
   <strong>Error!</strong> Wrong Model!</div>
      ...
      <div id = "rejectzero" class="alert alert-danger alert-dismissible" role="alert" hidden>
   <!-- <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> Please input REJECT Quantity!</div>
...
<option value ='<?php echo $SelectModel[$i]->getModel(); ?>' <?php if($cmbmodel==$SelectModel[$i]->getModel()) {echo "selected";} ?> ><?php echo $SelectModel[$i]->getModel(); ?> </option>
  ...
  <div class="panel panel-primary">
                    <div class="panel-heading">Mother SerialNumber Details</div>
                ...
                <div class="panel panel-primary" >
                  ...
                  <div class="panel-body">
                      ...
                      <div class="row">
                         ...
                         <div class="col-md-6">
                            <select id="cmbchildmodel" class="form-control input-sm" name="cmbchildmodel" disabled>
                              <option></option> 
                                <?php 
                                  $childmodel = Model::SelectAllChildModel($_SESSION['account']);
                                  for($i=0;$i<count($childmodel);$i++){
                                ?>
                                  <option><?php echo $childmodel[$i]->getModel(); ?></option>
                                <?php } ?>
                            </select><br>
                         </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                         ...
                         <div class="col-md-5">
                            <input id="txtRejectQty" type="number" value="0" min="1" name="txtRejectQty" class="form-control input-sm" disabled><br>
                         </div>
                         <div class="col-md-4">
  ...
  $(document).ready(function () {
      ...
      if (document.getElementById("ScmbModel").value == '') { 
         ...
         /*      alert(result)*/
            ...
            xmlhttp.open("GET", "../php/updatemother.php?serialno=" + document.getElementById("StextSerial").value +"&line="+document.getElementById("ScmbLine").value +"&model="+document.getElementById("ScmbModel").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value+"&Qty="+ document.getElementById("txtQty").value, true);
            xmlhttp.send();
      ...
      if (document.getElementById("StextSerial").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
              ...
              xmlhttp.open("GET", "../php/getmotherserial.php?serialno=" + document.getElementById("StextSerial").value +"&model=" + document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
          }
     ...
     var xmlhttp = new XMLHttpRequest();
           ...
           /*    alert(result);*/
                if(res[0] == 'success'){
                  ...
                  document.getElementById("cmbchildmodel").disabled = false;
            ...
            xmlhttp.open("GET", "../php/mother_rejectstatus.php?serialno=" + document.getElementById("StextSerial").value +"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          }
        ...
        tblcount = $('#tbldetails tr').length;
          ...
          $( "#btnadd" ).click(function() {
            ...
            if (document.getElementById("txtRejectQty").value == (0 && '')) {

                 document.getElementById("rejectzero").setAttribute("hidden","");
                document.getElementById("rejectzero").removeAttribute("hidden");
                document.getElementById("txtRejectQty").focus();
                  document.getElementById("txtRejectQty").select();
            ...
            $('#tbldetails > tbody').append('<tr id="tr'+tblcount+'">'+
                                            ...
                                            '<td><input type="hidden" id = "hrejectchild[]" name="hrejectchild[]" value="'+$('#cmbchildmodel').val()+'">'+$('#cmbchildmodel').val()+'</td>'+
          ...
          $( "#btnRejDone" ).click(function() {
            ...
            var hrejectchild = $('input[name="hrejectchild[]"]').map(function () {
            return this.value; }).get();
            ...
            if (this.readyState == 4 && this.status == 200) {
               var result = this.responseText;
                ...
                document.getElementById("btnGood").disabled = true;
                document.getElementById("btnReject").disabled = true;
                document.getElementById("cmbchildmodel").disabled = true;
            ...
            xmlhttp.open("GET", "../php/addrejectmothertesting.php?serialno=" + document.getElementById("StextSerial").value +"&hrejectcat="+JSON.stringify(hrejectcat)+"&hrejectcode="+JSON.stringify(hrejectcode)+"&hlocation="+JSON.stringify(hlocation)+"&hrejectchild="+JSON.stringify(hrejectchild)+"&hRejectQty="+JSON.stringify(hRejectQty)+"&hdetails="+JSON.stringify(hdetails)+"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value+"&Qty="+ document.getElementById("txtQty").value+"&model="+ document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
