...
<main class="mdl-layout__content mdl-color--grey-100">
  <div class="mdl-grid demo-content">
   ...
   <div id="alertdiv" class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell--top mdl-cell--12-col mdl-grid" style="margin-top:15px;" hidden="">
    <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-desktop">
      ...
      <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell--top mdl-cell--4-col mdl-grid" style="margin-top:15px;" >
        <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-desktop">
  ...
  <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell--top mdl-cell--8-col mdl-grid" style="margin-top:15px;" >
    <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-desktop">
