...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> Lot Number<!-- <b id="Serial_Error5" name="Serial_Error5"></b> --> is REJECT!</div>
        ...
        <div id = "lotlink" class="alert alert-danger alert-dismissible" role="alert" hidden>
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> Lot Number<!-- <b id="Serial_Error5" name="Serial_Error5"></b> --> is not yet Linked!</div>
          ...
          if(keycode == '13'){
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               var res = result.split("_");
                ...
                document.getElementById("lotlink").setAttribute("hidden","");
                document.getElementById("lotlink").removeAttribute("hidden");
                document.getElementById("StextLotNo").select();
            ...
            xmlhttp.open("GET", "../php/fpcaqas1.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value + "&station=" + document.getElementById("ScmbStation").value+"&RQuantity=test", true);
            xmlhttp.send();
