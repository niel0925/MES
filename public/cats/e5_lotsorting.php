      ...
      <div class="row" >
                    <div class="col-md-12">
                      <button type ="button" class="btn btn-primary emp-btn" id ="btnAdd" name="btnAdd" disabled style="margin-right:10px;">Add</button>  
                        ...
                        <button type ="button" class="btn btn-info emp-btn" id ="btnlotsort" name="btnlotsort" style="margin-right:10px;">Lot Sort</button>  
...
//           }
      ...
      if (document.getElementById("ScmbModel").value == '') { 
          ...
          return;
            ...
            document.getElementById("StextLotNo").innerHTML = "";  
             $('#StextLotNo').focus();
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               var res2 = result.split("&");
                ...
                if(res[0]== 'true'){
                      ...
                      $('#tblreject').append("<tr id ='tr1"+res3[8]+"'><td>"+res3[8]+"</td><td>"+res3[9]+"</td><td>"+res3[10]+"</td></tr>")
                    }
...
/* alert(result1);*/
                    for (a = 0; a < res5.length - 1; a++) { 
                      ...
                      $('#tblLot').append("<tr id ='tr"+res6[8]+"'><td>"+res6[8]+"</td><td>"+res6[9]+"</td><td>"+res6[10]+"</td><td>"+res6[11]+"</td></tr>")
                    }
  }
        };
          xmlhttp.open("GET", "../php/batchlotinfo.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value, true);
            xmlhttp.send();
          }
            ...
            xmlhttp.open("GET", "../php/batchlotdetails.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value, true);
            xmlhttp.send();
...
*/    
            ...
            xmlhttp.open("GET", "../php/batchlotserialsorting.php?serialno=" + document.getElementById("StextSerial").value + "&model=" + document.getElementById("ScmbModel").value+ "&lotnumber=" + document.getElementById("StextLotNo").value+"&station=" + document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          }
           ...
           $( "#btnlotsort" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/e5_lotsorting.php?lotno="+ document.getElementById("StextLotNo").value+"&qty=" + document.getElementById("StextQty").value +"&station=" + document.getElementById("txtLocation").value+"&model=" + document.getElementById("ScmbModel").value+"&status=" + document.getElementById("txtStatus").value, true);
            xmlhttp.send();
   ...
   tblcount = $('#tblLot tr').length;
      ...
      if(proceed == true || textSerial1.length == 0){
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               document.getElementById("StextQty").value =res[5];
               document.getElementById("btnRemove").disabled = true;
               document.getElementById("StextLotNo").disabled = true;
               document.getElementById("StextQty").disabled = true;
               document.getElementById("StextRejQty").disabled = true;
          ...
          $('#tblLot > tbody').append('<tr id="tr'+res[1]+'">'+
            ...
            '<td><input type="hidden" id = "txtquantity[]"  name="txtquantity[]" value="'+res[4]+'">'+res[4]+'</td>'+
          '</tr>');
  ...
  xmlhttp.open("GET", "../php/batchlotsortingadd.php?lotno="+ document.getElementById("StextLotNo").value+"&modelno=" + document.getElementById("ScmbModel").value+"&serialno=" + document.getElementById("StextSerial").value+"&station="+document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          ...
          $( "#btnRemove" ).click(function() {
           ...
           $("#tr1"+serialval).remove();
            ...
            xmlhttp.open("GET", "../php/batchlotsortingremove.php?lotno="+ document.getElementById("StextLotNo").value+"&modelno=" + document.getElementById("ScmbModel").value+"&serialno=" + document.getElementById("StextSerial").value+"&station=" + document.getElementById("txtLocation").value, true);
            xmlhttp.send();
