...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
  ...
  <div id = "successgood" class="alert alert-success alert-dismissible" role="alert" hidden>
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Success!</strong> Serial <b id="Serial_Error9" name="Serial_Error9"></b> is GOOD!</div>
  ...
  <div class="form-group">
   <div class="row">
    <div class="col-sm-4">
      ...
      <input type="number" class="form-control" id="rejectcount" name="rejectcount" value ="0" onkeypress="if (event.keyCode == 13)  return false;" disabled>
         </div> 
        </div> 
    </div> 
                ...
                <div class="panel panel-primary" >
                  ...
                  <div class="panel-body">
                      ...
                      <div class="row">
                         ...
                         <div class="col-md-5">
                            <input id="txtquantity" type="number" name="txtquantity" class="form-control input-sm" disabled><br>
                         </div>
                      </div>
                      <div class="row">
                         <div class="col-md-3">
...
//           }
      ...
      if (document.getElementById("ScmbModel").value == '') { 
          ...
          if(keycode == '13'){
            ...
            xmlhttp.open("GET", "../php/B9_batchqasformat.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value + "&station=" + document.getElementById("ScmbStation").value+"&RQuantity=test", true);
            xmlhttp.send();
  ...
  $('#SamplingQuantity').keyup(function(event){
    ...
    if(proceed == true || hserialno.length == 0){
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               var res = result.split("_");
                ...
                document.getElementById("txtModel").value = res[3];
                document.getElementById("txtRev").value = res[4];
            ...
            xmlhttp.open("GET", "../php/B9_batchqasserial.php?serialno=" + document.getElementById("StextSerial").value + "&model=" + document.getElementById("ScmbModel").value + "&station=" + document.getElementById("ScmbStation").value+ "&lotnumber=" + document.getElementById("StextLotNo").value, true);
            xmlhttp.send();
          }
   ...
   tblcount = $('#tbldetails tr').length;
          ...
          $( "#btnGood" ).click(function() {
                ...
                if(res[0] == 'false'){
                     ...
                     $('#tblsampling > tbody').append('<tr id="tr'+tblcount+'">'+
                                              ...
                                              /*  '<td><input type="hidden" id = "hmodel[]" name="hmodel[]" value="'+res[3]+'">'+res[3]+'</td>'+*/
                                                '<td><input type="hidden" id = "hqty[]" name="hqty[]" value="'+res[4]+'">'+res[4]+'</td>'+
                                                 '<td><input type="hidden" id = "hstatus[]" name="hstatus[]" value="'+'GOOD'+'">'+'GOOD'+'</td>'+
                     ...
                     document.getElementById("btnGood").disabled = true;
                     document.getElementById("btnReject").disabled = true;
                     document.getElementById("successgood").setAttribute("hidden","");
                     document.getElementById("successgood").removeAttribute("hidden");
          
                     document.getElementById("Serial_Error9").innerHTML = res[1];
                     $("#StextSerial").focus();
                  ...
                  document.getElementById("SamplingCount").value = res[2];
                    $('#tblsampling > tbody').append('<tr id="tr'+tblcount+'">'+
                                              ...
                                              /*  '<td><input type="hidden" id = "hmodel[]" name="hmodel[]" value="'+res[3]+'">'+res[3]+'</td>'+*/
                                                '<td><input type="hidden" id = "hqty[]" name="hqty[]" value="'+res[4]+'">'+res[4]+'</td>'+
                                                '<td><input type="hidden" id = "hstatus[]" name="hstatus[]" value="'+res[5]+'">'+res[5]+'</td>'+
                                                '<td><button type="button" onclick="removeRow('+tblcount+')" type="button" class="btn btn-danger btn-sm">Remove</button></td>'+
                                                '</tr>');
            ...
            xmlhttp.open("GET", "../php/batchqasinsert.php?serialno=" + document.getElementById("StextSerial").value+"&lotno="+ document.getElementById("StextLotNo").value +"&station=" + document.getElementById("ScmbStation").value+"&quantity=" + document.getElementById("SamplingQuantity").value+"&count=" + document.getElementById("SamplingCount").value, true);
            xmlhttp.send();
           ...
           $( "#btnlot" ).click(function() {
            ...
            return this.value; }).get();
            var hstatus1 = $('input[name="hstatus[]"]').map(function () {
            return this.value; }).get();
            ...
            if (this.readyState == 4 && this.status == 200) {
               var result = this.responseText;
                ...
                document.getElementById("LotQuantity").value = '';
                document.getElementById("SamplingQuantity").value = '0';
                document.getElementById("rejectcount").value = '0';
            ...
            xmlhttp.open("GET", "../php/B9_qasclosetest.php?refno="+ document.getElementById("StextLotNo").value +"&station=" + document.getElementById("ScmbStation").value+"&station=" + document.getElementById("ScmbStation").value+"&rejcount=" + document.getElementById("rejectcount").value+"&samplingCount=" + document.getElementById("SamplingCount").value+"&modelno=" + document.getElementById("ScmbModel").value+"&hserialno=" + JSON.stringify(hserialno1)+"&hqty=" + JSON.stringify(hqty1)+"&hstatus=" + JSON.stringify(hstatus1), true);
            xmlhttp.send();
...
tblcount1 = $('#tbldetails tr').length;
          ...
          $( "#btnadd" ).click(function() {
            ...
            $('#tbldetails > tbody').append('<tr id="tr'+tblcount1+'">'+
                                            ...
                                            '<td><input type="hidden" id = "hquantity[]" name="hquantity[]" value="'+$('#txtquantity').val()+'">'+$('#txtquantity').val()+'</td>'+
          ...
          $( "#btnRejDone" ).click(function() {
            ...
            return this.value; }).get();
             ...
             var hquantity = $('input[name="hquantity[]"]').map(function () {
            return this.value; }).get();
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               // alert(result);
                ...
                if(res[0] == 'successreject'){
                    ...
                    document.getElementById("StextLotNo").disabled = true;
                    document.getElementById("SamplingQuantity").disabled = true;
                    document.getElementById("LotQuantity").disabled = true;
                    document.getElementById("StextSerial").disabled = true;
                    ...
                    if(document.getElementById("SamplingQuantity").value == res[2]){
                    ...
                    document.getElementById("SamplingCount").value = res[2];
                    document.getElementById("rejectcount").value = res[1];

                    $('#tblsampling > tbody').append('<tr id="tr'+tblcount+'">'+
                                                '<td><input type="hidden" id = "hserialno[]" name="hserialno[]" value="'+res[3]+'">'+res[3]+'</td>'+
                                                '<td><input type="hidden" id = "hqty[]" name="hqty[]" value="'+res[4]+'">'+res[4]+'</td>'+
                                                '<td><input type="hidden" id = "hstatus[]" name="hstatus[]" value="'+res[5]+'">'+res[5]+'</td>'+
                                                '<td><button type="button" onclick="removeRow('+tblcount+')" type="button" class="btn btn-danger btn-sm">Remove</button></td>'+
                                                '</tr>');
            ...
            xmlhttp.open("GET", "../php/B9_addrejectqastest.php?serialno=" + document.getElementById("StextSerial").value +"&hrejectcat="+JSON.stringify(hrejectcat)+"&hrejectcode="+JSON.stringify(hrejectcode)+"&hlocation="+JSON.stringify(hlocation)+"&hdetails="+JSON.stringify(hdetails)+"&hRejectQty="+JSON.stringify(hquantity)+"&line=noline"+"&station="+ document.getElementById("ScmbStation").value+"&nextStation=noresult"+"&lotno="+ document.getElementById("StextLotNo").value+"&modelno="+ document.getElementById("ScmbModel").value+"&Qty="+ document.getElementById("txtqty").value+"&count=" + document.getElementById("SamplingCount").value+"&quantity=" + document.getElementById("SamplingQuantity").value+"&reference=" + document.getElementById("StextLotNo").value+"&rejectcount=" + document.getElementById("rejectcount").value, true);
            xmlhttp.send();
