        ...
        // alert(result);
         if( res[0]  == 'success'){
          ...
          document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/F5_batchlink_StextSerial.php?serialno=" + document.getElementById("StextSerial").value +"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
         ...
         if( res[0]  == 'info'){
              ...
              /*  document.getElementById("successlink").setAttribute("hidden","");
                ...
                if(res[4]==0){
                  ...
                  document.getElementById('StextSerial2').readOnly = false;
                }
                if(res[2]==0){
            ...
            xmlhttp.open("GET", "../php/F5_batchlink_StextSerial4.php?serialno1=" + document.getElementById("StextSerial").value +"&serialno2="+ document.getElementById("StextSerial2").value+"&serialno4="+ document.getElementById("StextSerial4").value+"&qty1="+ document.getElementById("txtQty").value+"&qty4="+ document.getElementById("txtQty4").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
