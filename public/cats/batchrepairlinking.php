       ...
       <div id = "success" class="alert alert-success alert-dismissible" role="alert" hidden>
        ...
        <div id = "successreject" class="alert alert-success alert-dismissible" role="alert" hidden>
          ...
          <div id = "error" class="alert alert-danger alert-dismissible" role="alert" hidden>
            <strong>Error!</strong> Serial <b id="lblError" name="lblError"></b> does not exist!</div>
          <div id = "error1" class="alert alert-danger alert-dismissible" role="alert" hidden>
            <strong>Error!</strong> Serial <b id="Serial_Error1" name="Serial_Error1"></b> does not exist!</div>
                ...
                <div id = "forlotmaking" class="alert alert-danger alert-dismissible" role="alert" hidden>
                  ...
                  <div id = "serialreject" class="alert alert-danger alert-dismissible" role="alert" hidden>
                   ...
                   <div id = "wrongmodel" class="alert alert-danger alert-dismissible" role="alert" hidden>
                    ...
                    <input type="number" class="form-control" id="txtSequence" name="txtSequence" disabled>
                  </div> -->
                  </div>
                  </div>
                  <!-- <div class="form-group">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" min="0" max="200" class="form-control" id="txtRemaining" name="txtRemaining" disabled>
                  </div>
                </div>
              </div>
              <div class="form-group">
         ...
         $('#cmbModel').change(function (){
            if (document.getElementById("cmbModel").value == '') { 
              ...
              xmlhttp.onreadystatechange = function() {
                ...
                // xmlhttp.open("GET", "../php/getmodelroute.php?modelno=" + document.getElementById("cmbModel").value+"&formodel=0&station=test", true);
                // xmlhttp.send();
              }
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         var res = result.split("_");
                ...
                if( res[0]  == 'success'){
                  ...
                  document.getElementById("txtRemaining").value = res[2];
...
*/
            ...
            xmlhttp.open("GET", "../php/seriallinkingStextSerial.php?serial1=" + document.getElementById("StextSerial").value +"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         var res = result.split("_");
                ...
                if( res[0]  == 'success'){
                  ...
                  document.getElementById("txtRemaining").value = res[5];
            ...
            xmlhttp.open("GET", "../php/seriallinkingStextSerial2.php?serial1=" + document.getElementById("StextSerial").value +"&serial2="+ document.getElementById("StextSerial2").value +"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value+"&pwbqty="+ document.getElementById("txtQty").value, true);
            xmlhttp.send();
          }
