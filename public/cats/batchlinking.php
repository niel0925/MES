              ...
              <div id = "forcardlink" class="alert alert-danger alert-dismissible" role="alert" hidden>
                ...
                <div id = "forlotmaking" class="alert alert-danger alert-dismissible" role="alert" hidden>
                   ...
                   <div id = "wrongmodel" class="alert alert-danger alert-dismissible" role="alert" hidden>
                     ...
                     <form method="POST">
                      <div class="form-group">
                        ...
                        <Select class="form-control" id="cmbModel" name="cmbModel" >
                         <option></option>
                         <?php 
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="txtQty" name="txtQty" onkeypress="if (event.keyCode == 13)  return false;" readonly >
                  </div>
                </div>
              </div>
              <div class="form-group">
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         var res = result.split("_");
                ...
                if( res[0]  == 'success'){
                  ...
                  document.getElementById("btnGood").disabled = false;
                  document.getElementById("btnReject").disabled = false;
                  document.getElementById("StextSerial2").disabled = false;
                  $('#StextSerial2').focus();
            ...
            xmlhttp.open("GET", "../php/linkingStextSerial2.php?did=" + document.getElementById("StextSerial").value +"&serialno="+ document.getElementById("StextSerial2").value +"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
