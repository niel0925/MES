        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/B9_motherseriallink_TH_StextSerial.php?serialno=" + document.getElementById("StextSerial").value +"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
