...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Success!</strong> Lot number <b id="SerialNumber" name="SerialNumber"></b> is successfully completed!</div>
     ...
     <div id = "notcomplete" class="alert alert-danger alert-dismissible" role="alert" hidden>
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error</strong> Lot number <b id="SerialNumber" name="SerialNumber"></b> is not yet completed!</div>
...
//           }
      ...
      if (document.getElementById("ScmbModel").value == '') { 
          ...
          if(keycode == '13'){
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               var res = result.split("_");
                ...
                document.getElementById("SamplingQuantity").disabled = false; 
                 ...
                 document.getElementById("notcomplete").setAttribute("hidden","");
                ...
                document.getElementById("notcomplete").setAttribute("hidden","");
                document.getElementById("lotnotexist").setAttribute("hidden","");
                document.getElementById("notcomplete").removeAttribute("hidden");
            ...
            xmlhttp.open("GET", "../php/qasformat.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value + "&station=" + document.getElementById("ScmbStation").value+"&RQuantity=test", true);
            xmlhttp.send();
