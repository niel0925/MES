      ...
      <Select class="form-control" id="ScmbModel" name="ScmbModel" >
        ...
        <?php 
            $SelectModel = Model::SelectAllModel($_SESSION['account']);
                ...
                ?>
<option value ='<?php echo $SelectModel[$i]->getModel();?>' <?php if($cmbmodel==$SelectModel[$i]->getModel()) {echo "selected";} ?> ><?php echo $SelectModel[$i]->getModel(); ?> <?php echo $SelectModel[$i]->getLatestRev(); ?></option>
         <?php 
       }
       ?> 
      </Select>
...
/* alert(result1);*/
          ...
          xmlhttp.open("GET", "../php/lotinfo.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value, true);
            xmlhttp.send();
          }
            ...
            xmlhttp.open("GET", "../php/lotdetails.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value, true);
            xmlhttp.send();
          ...
          $('#StextSerial').keyup(function(event){
            ...
            xmlhttp.open("GET", "../php/lotserialsorting.php?serialno=" + document.getElementById("StextSerial").value + "&model=" + document.getElementById("ScmbModel").value+ "&lotnumber=" + document.getElementById("StextLotNo").value+"&station=" + document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          }
           ...
           $( "#btnlotsort" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/fpcalotsorting.php?lotno="+ document.getElementById("StextLotNo").value+"&qty=" + document.getElementById("StextQty").value +"&station=" + document.getElementById("txtLocation").value+"&model=" + document.getElementById("ScmbModel").value+"&status=" + document.getElementById("txtStatus").value, true);
            xmlhttp.send();
  ...
  xmlhttp.open("GET", "../php/lotsortingadd.php?lotno="+ document.getElementById("StextLotNo").value+"&modelno=" + document.getElementById("ScmbModel").value+"&serialno=" + document.getElementById("StextSerial").value+"&station="+document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          ...
          $( "#btnRemove" ).click(function() {
           ...
           $("#tr1"+serialval).remove();
            ...
            xmlhttp.open("GET", "../php/lotsortingremove.php?lotno="+ document.getElementById("StextLotNo").value+"&modelno=" + document.getElementById("ScmbModel").value+"&serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp.send();
