      ...
      if (document.getElementById("StextSerial").value == '') {     
          return;
           ...
           $("#tbldetails").find("tr:not(:first)").remove();
                ...
                for (i = 0; i < TrackingNo.length - 1; i++) { 
                   $('#tbldetails').append('<tr id="tr'+TrackingNo[i]+'">'+
                                            ...
                                            '<td align ="center"><input type="hidden" id = "hlocation[]" name="hlocation[]" value="'+Defect[i]+'">'+Defect[i]+'</td>'+
                                             '<td align ="center"><input type="hidden" id = "hchildmodel[]" name="hchildmodel[]" value="'+Childmodel[i]+'">'+Childmodel[i]+'</td>'+
            ...
            xmlhttp1.open("GET", "../php/motherrejectdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp1.send();
            ...
            xmlhttp.open("GET", "../php/motherrepairdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp.send();
          }
...
*/
            ...
            xmlhttp1.open("GET", "../php/motherreworkreject.php?serialno=" + document.getElementById("StextSerial").value+"&trackRepair="+JSON.stringify(trackRepair)+"&trackremarks="+JSON.stringify(trackremarks)+"&station="+ document.getElementById("txtLocation").value, true);
            xmlhttp1.send();
...
/*
        $( "#btnReturn" ).click(function() {
          ...
          var xmlhttp1 = new XMLHttpRequest();
            ...
            xmlhttp1.open("GET", "../php/returnrejectnew.php?serialno=" + document.getElementById("StextSerial").value+"&newstation="+ document.getElementById("ScmbStation").value+"&station="+ document.getElementById("txtLocation").value+"&model="+ document.getElementById("txtModel").value, true);
            xmlhttp1.send();
