              ...
              <div id = "offroute" class="alert alert-danger alert-dismissible" role="alert" hidden>
                ...
                <div class="form-group">
                    <div class="row">
                     ...
                     <div class="col-md-3">
                        <label for="pwd">Qty:</label>
                        <input type="number" min="0" max="200" class="form-control" id="txtQty2" name="txtQty2" value="<?php echo $qty2;?>" readonly>
                      </div>
                  </div>
                </div>
                <div class="form-group">
                    <div class="row">
                     <div class="col-md-9">
                      <label for="pwd">H919ITLC:</label>
                      <input type="text" class="form-control" id="StextSerial3" name="StextSerial3" onkeypress="if (event.keyCode == 13)  return false;" readonly>
                    </div>
                     <div class="col-md-3">
                        <label for="pwd">Qty:</label>
                        <input type="number" min="0" max="200" class="form-control" id="txtQty3" name="txtQty3" value="<?php echo $qty3;?>" readonly>
                      </div>
                  </div>
                </div>
                <div class="form-group">
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/B9_linking_H919_StextSerial.php?serialno=" + document.getElementById("StextSerial").value +"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
...
$('#StextSerial2').keyup(function(event){
  ...
  if(keycode == '13'){
    ...
    xmlhttp.open("GET", "../php/B9_linking_H919_StextSerial2.php?serialno=" + document.getElementById("StextSerial").value +"&serialno2="+ document.getElementById("StextSerial2").value+"&sequence="+ document.getElementById("txtSeq").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
    xmlhttp.send();
  }
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          //document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/B9_linking_H919_StextSerial3.php?serialno=" + document.getElementById("StextSerial").value +"&serialno2="+ document.getElementById("StextSerial2").value+"&serialno3="+ document.getElementById("StextSerial3").value+"&sequence="+ document.getElementById("txtSeq").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          if(res[8]==0){
            ...
            document.getElementById("StextSerial4").value = res[7];
            document.getElementById('StextSerial4').focus();
          }
          if(res[6]==20){
            $("#StextSerial3").attr("readonly",false);
          ...
          //document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/B9_linking_H919_StextSerial4.php?serialno1=" + document.getElementById("StextSerial").value +"&serialno2="+ document.getElementById("StextSerial2").value+"&serialno3="+ document.getElementById("StextSerial3").value+"&serialno4="+ document.getElementById("StextSerial4").value+"&qty1="+ document.getElementById("txtQty").value+"&qty2="+ document.getElementById("txtQty2").value+"&qty3="+ document.getElementById("txtQty3").value+"&qty4="+ document.getElementById("txtQty4").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
