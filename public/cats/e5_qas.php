...
//           }
      ...
      if (document.getElementById("ScmbModel").value == '') { 
          ...
          if(keycode == '13'){
           ...
           /*     alert(result);*/
            ...
            xmlhttp.open("GET", "../php/batchqasformat.php?model=" + document.getElementById("ScmbModel").value + "&lotno=" + document.getElementById("StextLotNo").value + "&station=" + document.getElementById("ScmbStation").value+"&RQuantity=test", true);
            xmlhttp.send();
  ...
  $('#SamplingQuantity').keyup(function(event){
    ...
    if(proceed == true || hserialno.length == 0){
            ...
            xmlhttp.open("GET", "../php/batchqasserial.php?serialno=" + document.getElementById("StextSerial").value + "&model=" + document.getElementById("ScmbModel").value + "&station=" + document.getElementById("ScmbStation").value+ "&lotnumber=" + document.getElementById("StextLotNo").value, true);
            xmlhttp.send();
          }
   ...
   tblcount = $('#tbldetails tr').length;
         ...
         /*       alert(result);*/
            ...
            xmlhttp.open("GET", "../php/e5_batchqasclose.php?lotno="+ document.getElementById("StextLotNo").value +"&station=" + document.getElementById("ScmbStation").value+"&samplingCount=" + document.getElementById("SamplingCount").value+"&modelno=" + document.getElementById("ScmbModel").value+"&hserialno=" + JSON.stringify(hserialno1)+"&hqty=" + JSON.stringify(hqty1)+"&hstatus=" + JSON.stringify(hstatus1), true);
            xmlhttp.send();
          ...
          /*      document.getElementById("StextSerial").value = '';
                ...
                document.getElementById("txtdetails").value = '';
                           ...
                           $('#tblsampling > tbody').append('<tr id="tr'+tblcount+'">'+
                                                '<td><input type="hidden" id = "hserialno[]" name="hserialno[]" value="'+res[1]+'">'+res[1]+'</td>'+
                                          /*      '<td><input type="hidden" id = "hmodel[]" name="hmodel[]" value="'+res[3]+'">'+res[3]+'</td>'+*/
                                                '<td><input type="hidden" id = "hqty[]" name="hqty[]" value="'+res[3]+'">'+res[3]+'</td>'+
                                                '<td><input type="hidden" id = "hstatus[]" name="hstatus[]" value="'+res[4]+'">'+res[4]+'</td>'+
                                                '<td><button type="button" onclick="removeRow('+tblcount+')" type="button" class="btn btn-danger btn-sm">Remove</button></td>'+
                                                '</tr>');
