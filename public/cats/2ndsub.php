  ...
  $(document).ready(function () {
      ...
      if (document.getElementById("StextSerial").value == '') {     
          ...
          /*      alert(res2);*/
            ...
            xmlhttp2.open("GET", "../php/getbeforestation.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp2.send();
          ...
          /* $("#tbldetails").find("tr:not(:first)").remove();*/
            ...
            xmlhttp.open("GET", "../php/addrepairdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp.send();
          }
    ...
    $('#ScmbStation').change(function (){
        ...
        $( "#btnReturn" ).click(function() {
          ...
          var xmlhttp1 = new XMLHttpRequest();
            ...
            xmlhttp1.open("GET", "../php/addreturnreject.php?serialno=" + document.getElementById("StextSerial").value+"&newstation="+ document.getElementById("ScmbStation").value+"&model="+ document.getElementById("txtModel").value+"&qty="+ document.getElementById("txtqty").value+"&station="+ document.getElementById("txtLocation").value, true);
            xmlhttp1.send();
