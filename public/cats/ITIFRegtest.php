   ...
   <strong>Error!</strong> Child Model <b id="Serial_Error3" name="Serial_Error3"></b> not belong to Mother Model!</div>
    ...
    <div class="form-group">
      ...
      <Select class="form-control" id="ScmbModel" name="ScmbModel">
        <option></option>
        <?php 
            $SelectModel = Model::SelectMotherModelB9($_SESSION['account']);
...
tblcount = $('#tblChild tr').length;
          ...
          '</tr>');
             ...
             document.getElementById("StextChildSerial").focus();
              ...
              xmlhttp.open("GET", "../php/serialtomotherlink1.php?serialno=" + document.getElementById("StextChildSerial").value +"&model="+ document.getElementById("ScmbModel").value + "&line=" + document.getElementById("ScmbLine").value + "&type=" + document.getElementById("Scmbtype").value, true);
            xmlhttp.send();
          }
