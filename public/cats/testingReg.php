...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> <b id="Serial1_Error3" name="Serial1_Error3"></b>: Wrong serial format!</div>

   <div id = "error4" class="alert alert-danger alert-dismissible" role="alert" hidden>
 <!--   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> Serial <b id="Serial_Error9" name="Serial_Error9"></b> is already exist!</div>
      ...
      if (document.getElementById("ScmbModel").value == '') { 
         ...
         $( "#btnGood" ).click(function() {
          ...
          var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "../php/RegFirstStation.php?serialno=" + document.getElementById("StextSerial").value +"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value+"&model="+ document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
      ...
      if (document.getElementById("StextSerial").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
              ...
              xmlhttp.open("GET", "../php/Registrationgetserial.php?serialno=" + document.getElementById("StextSerial").value +"&model=" + document.getElementById("ScmbModel").value +"&station=" + document.getElementById("ScmbStation").value +"&line=" + document.getElementById("ScmbLine").value, true);
            xmlhttp.send();
          }
...
if (document.getElementById("StextSerial").value == '') { 
     ...
     var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "../php/RejectFirstStatus.php?serialno=" + document.getElementById("StextSerial").value +"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          }
        ...
        tblcount = $('#tbldetails tr').length;
          ...
          $( "#btnRejDone" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/RejectFirst.php?serialno=" + document.getElementById("StextSerial").value +"&hrejectcat="+JSON.stringify(hrejectcat)+"&hrejectcode="+JSON.stringify(hrejectcode)+"&hlocation="+JSON.stringify(hlocation)+"&hdetails="+JSON.stringify(hdetails)+"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value+"&model="+ document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
