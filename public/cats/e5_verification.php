 ...
 function removeRow(row){
  ...
  $(document).ready(function () {
      ...
      if (document.getElementById("StextSerial").value == '') {     
          return;
           ...
           /*     alert(res2);*/
            ...
            xmlhttp2.open("GET", "../php/batchbeforestation.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp2.send();
           ...
           $("#tbldetails").find("tr:not(:first)").remove();
                ...
                for (i = 0; i < TrackingNo.length - 1; i++) { 
                   $('#tbldetails').append('<tr id="tr'+TrackingNo[i]+'">'+
                                            ...
                                            '<td align ="center"><input id = "hremarks'+TrackingNo[i]+'" name="hremarks'+TrackingNo[i]+'" value=""></td>'+                                         
                                             '<td align ="center"><input type="checkbox"  id="chkRepair'+TrackingNo[i]+'" name="chkRepair'+TrackingNo[i]+'" value="1" style="margin-left:auto; margin-right:auto;"> Verify</td>'+
                                            '</tr>');
                 }
            ...
            xmlhttp1.open("GET", "../php/batchrejectdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp1.send();
            ...
            xmlhttp.open("GET", "../php/batchrepairdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp.send();
          }
   ...
   /*             alert(result);*/
            ...
            xmlhttp1.open("GET", "../php/e5_verifyreturn.php?serialno=" + document.getElementById("StextSerial").value+"&newstation="+ document.getElementById("ScmbStation").value+"&station="+ document.getElementById("txtLocation").value+"&qty="+ document.getElementById("txtqty").value+"&model="+ document.getElementById("txtModel").value, true);
            xmlhttp1.send();
