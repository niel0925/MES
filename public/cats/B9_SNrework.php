      ...
      if (document.getElementById("StextSerial").value == '') {     
          return;
           ...
           $("#tbldetails").find("tr:not(:first)").remove();
            ...
            xmlhttp1.open("GET", "../php/B9_SNrejectdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp1.send();
            ...
            xmlhttp.open("GET", "../php/B9_SNrepairdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp.send();
          }
