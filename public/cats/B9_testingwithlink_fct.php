...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
 ...
 <!--   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   ...
   <div id = "wrongmac" class="alert alert-danger alert-dismissible" role="alert" hidden>
   <strong>Error!</strong> Wrong Mac Address!</div>
    ...
    <div class="form-group">
      ...
      <Select class="form-control" id="ScmbModel" name="ScmbModel" >
        <option></option>
        <?php 
            $SelectModel = Model::SelectAllChildModel2($_SESSION['account']);
...
<option value ='<?php echo $SelectModel[$i]->getModel(); ?>' <?php if($cmbmodel==$SelectModel[$i]->getModel()) {echo "selected";} ?> ><?php echo $SelectModel[$i]->getModel(); ?></option>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="StextSerial2" name="StextSerial2" onkeypress="if (event.keyCode == 13)  return false;" disabled >
    </div>
...
document.getElementById("StextSerial2").disabled = true;
 document.getElementById("StextSerial2").value = '';
      if (document.getElementById("ScmbModel").value == '') { 
          ...
          return;
            ...
            xmlhttp.open("GET", "../php/B9_testingwithlink_fct_getmodelroute.php?modelno=" + document.getElementById("ScmbModel").value+"&formodel=0&station=test", true);
            xmlhttp.send();
          }
          ...
          if (document.getElementById("ScmbStation").value == '') {
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               if(result == 1){
                ...
                document.getElementById("btnGood").disabled = true;
                document.getElementById("btnReject").disabled = true;
               }else{document.getElementById("StextSerial").removeAttribute("readonly");
                document.getElementById("ScmbLine").disabled = true;
                document.getElementById("ScmbLine").value = '';
                document.getElementById("StextSerial").disabled = false;
                document.getElementById("StextSerial").value = '';
         ...
         $( "#btnGood" ).click(function() {
          ...
          var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "../php/B9_testingwithlink_fct_updatecard.php?serialno=" + document.getElementById("StextSerial").value +"&serialno2="+document.getElementById("StextSerial2").value+"&line="+document.getElementById("ScmbLine").value+"&station="+ document.getElementById("ScmbStation").value+"&model="+ document.getElementById("ScmbModel").value+"&nextStation="+ document.getElementById("txtLocation").value, true);
            xmlhttp.send();
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               if( res[0]  == 'success'){
                ...
                if(res[7]=='notready'){
                  ...
                  document.getElementById("StextSerial2").removeAttribute("disabled");
                ...
                document.getElementById("txtCreatedBy").value = res[6];
                  ...
                  document.getElementById("StextSerial").setAttribute("readonly","");
                  document.getElementById("StextSerial2").value = res[8];
                document.getElementById("success").setAttribute("hidden","");
                document.getElementById("offroute").setAttribute("hidden","");
                document.getElementById("error1").setAttribute("hidden","");
                document.getElementById("forlotmaking").setAttribute("hidden","");
                ...
                document.getElementById('btnGood').focus();
              ...
              xmlhttp.open("GET", "../php/B9_testingwithlink_fct_getserial.php?serialno=" + document.getElementById("StextSerial").value +"&model=" + document.getElementById("ScmbModel").value+"&station=" + document.getElementById("ScmbStation").value, true);
            xmlhttp.send();
          }
      ...
      if (document.getElementById("StextSerial2").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
              ...
              }else if(res[0] == 'wrongmac'){
                document.getElementById("wrongmac").removeAttribute("hidden");
                document.getElementById("success").setAttribute("hidden","");
                document.getElementById("offroute").setAttribute("hidden","");
                document.getElementById("error1").setAttribute("hidden","");
              ...
              xmlhttp.open("GET", "../php/B9_testingwithlink_fct_getmac.php?serialno=" + document.getElementById("StextSerial2").value +"&model=" + document.getElementById("ScmbModel").value, true);
            xmlhttp.send();
          }
...
if (document.getElementById("StextSerial").value == '') { 
     ...
     var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "../php/rejectstatus.php?serialno=" + document.getElementById("StextSerial").value +"&serialno2="+document.getElementById("StextSerial2").value+"&line="+document.getElementById("ScmbLine").value+"&model="+document.getElementById("ScmbModel").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value, true);
            xmlhttp.send();
          }
        ...
        tblcount = $('#tbldetails tr').length;
          ...
          $( "#btnRejDone" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/B9_testingwithlink_fct_addreject.php?serialno=" + document.getElementById("StextSerial").value +"&serialno2="+document.getElementById("StextSerial2").value+"&hrejectcat="+JSON.stringify(hrejectcat)+"&hrejectcode="+JSON.stringify(hrejectcode)+"&hlocation="+JSON.stringify(hlocation)+"&hdetails="+JSON.stringify(hdetails)+"&line="+document.getElementById("ScmbLine").value+"&model="+document.getElementById("ScmbModel").value+"&station="+ document.getElementById("ScmbStation").value+"&nextStation="+ document.getElementById("txtLocation").value, true);
            xmlhttp.send();
