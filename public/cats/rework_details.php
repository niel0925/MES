...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Success!</strong> Serial reject details<b id="Serial_Error6" name="Serial_Error6"></b> is successfully added!</div>
...
<!--    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
 ...
 <!--   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> Serial <b id="Serial_Error5" name="Serial_Error5"></b> is REJECT!</div>
     ...
     <div id = "serialGood" class="alert alert-danger alert-dismissible" role="alert" hidden>
 <!--   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
   <strong>Error!</strong> Serial <b id="Serial_Error5" name="Serial_Error5"></b> is GOOD!</div>
   ...
   <strong>Error!</strong> Wrong Model!</div>
    ...
    <div class="row" >
                    <div class="col-md-12">
                        ...
                        <button style="float:left;" type ="button" class="btn btn-warning emp-btn" id ="btnReject" name="btnReject" disabled>Add Details</button>                   
                    </div>
      ...
      if (document.getElementById("StextSerial").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               if( res[0]  == 'success'){
                document.getElementById("success").setAttribute("hidden","");
                document.getElementById("serialGood").setAttribute("hidden","");
                document.getElementById("offroute").setAttribute("hidden","");
                document.getElementById("error1").setAttribute("hidden","");
                document.getElementById("forlotmaking").setAttribute("hidden","");
                document.getElementById("forcardlink").setAttribute("hidden","");
              ...
              xmlhttp.open("GET", "../php/getserial_rejectdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp.send();
          }
     ...
     var xmlhttp = new XMLHttpRequest();
            ...
            if (this.readyState == 4 && this.status == 200) {
               ...
               // alert(result);
                ...
                document.getElementById("serialGood").setAttribute("hidden","");
                document.getElementById("serialGood").removeAttribute("hidden");
                $('#StextSerial').focus();
            ...
            xmlhttp.open("GET", "../php/addrejectdetails.php?serialno=" + document.getElementById("StextSerial").value, true);
            xmlhttp.send();
          }
        ...
        tblcount = $('#tbldetails tr').length;
          ...
          $( "#btnRejDone" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/addrejectrepair.php?serialno=" + document.getElementById("StextSerial").value +"&hrejectcat="+JSON.stringify(hrejectcat)+"&hrejectcode="+JSON.stringify(hrejectcode)+"&hlocation="+JSON.stringify(hlocation)+"&hdetails="+JSON.stringify(hdetails)+"&station="+ document.getElementById("txtLocation").value, true);
            xmlhttp.send();
