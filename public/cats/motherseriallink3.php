            ...
            <div id = "error1" class="alert alert-danger alert-dismissible" role="alert" hidden>
              ...
              <div id = "offroute" class="alert alert-danger alert-dismissible" role="alert" hidden>
                ...
                <div class="form-group">
                    <div class="row">
                     <div class="col-md-9">
                      <label for="pwd">ITLB:</label>
                      <input type="text" class="form-control" id="StextSerial2" name="StextSerial2" onkeypress="if (event.keyCode == 13)  return false;" >
                    </div>
                     <div class="col-md-3">
                        <label for="pwd">Qty:</label>
                ...
                <div class="form-group">
                    <div class="row">
                     <div class="col-md-9">
                      <label for="pwd">H599:</label>
                      <input type="text" class="form-control" id="StextSerial4" name="StextSerial4" onkeypress="if (event.keyCode == 13)  return false;" >
                    </div>
                     <div class="col-md-3">
                        <label for="pwd">Qty:</label>
                        <input type="number" min="0" max="200" class="form-control" id="txtQty4" name="txtQty4" value="<?php echo $qty4;?>" readonly>
                      </div>
                  </div>
                </div>
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/motherseriallink3StextSerial.php?serialno=" + document.getElementById("StextSerial").value +"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
      ...
      xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          document.getElementById("txtQty4").value = res[6];

          if(res[6]==0){
            document.getElementById("StextSerial4").value = '';
          }else{
            document.getElementById("StextSerial4").value = res[5];
          }
          document.getElementById('StextSerial4').focus();
          // if(res[6]==120){
          ...
          if(res[2]==180){
            ...
            document.getElementById("StextSerial1").value = '';
            document.getElementById('StextSerial1').focus();
          }
          ...
          //document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/motherseriallink3StextSerial3.php?serialno1=" + document.getElementById("StextSerial").value +"&serialno2="+ document.getElementById("StextSerial2").value+"&serialno4="+ document.getElementById("StextSerial4").value+"&qty1="+ document.getElementById("txtQty").value+"&qty2="+ document.getElementById("txtQty2").value+"&qty4="+ document.getElementById("txtQty4").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
