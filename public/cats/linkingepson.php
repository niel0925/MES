        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          document.getElementById("txtQty").value = res[2];
            ...
            xmlhttp.open("GET", "../php/linkingafiStextSerial.php?serialno=" + document.getElementById("StextSerial").value +"&sequence="+ document.getElementById("txtSeq").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
...
$('#StextSerial2').keyup(function(event){
  ...
  if(keycode == '13'){
    ...
    xmlhttp.open("GET", "../php/linkingafiStextSerial2.php?serialno=" + document.getElementById("StextSerial").value +"&serialno2="+ document.getElementById("StextSerial2").value+"&sequence="+ document.getElementById("txtSeq").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
    xmlhttp.send();
  }
        ...
        if (this.readyState == 4 && this.status == 200) {
         ...
         if( res[0]  == 'success'){
          ...
          document.getElementById("success").setAttribute("hidden","");
            ...
            xmlhttp.open("GET", "../php/linkingafiStextSerial3.php?serialno=" + document.getElementById("StextSerial").value +"&serialno2="+ document.getElementById("StextSerial2").value+"&serialno3="+ document.getElementById("StextSerial3").value+"&sequence="+ document.getElementById("txtSeq").value+"&model="+ document.getElementById("cmbModel").value +"&station="+ document.getElementById("cmbStation").value +"&line="+ document.getElementById("cmbLine").value, true);
            xmlhttp.send();
          }
