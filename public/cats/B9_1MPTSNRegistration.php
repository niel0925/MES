...
?>
   ...
   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
   <strong>Error!</strong> Child Model <b id="Serial_Error3" name="Serial_Error3"></b> not belong to Mother Model!</div>
 ...
 <div class="form-group">
      ...
      <Select class="form-control" id="ScmbModel" name="ScmbModel">
        <option></option>
        <?php 
            $SelectModel = Model::SelectModelB9($_SESSION['account']);
...
<option value ='<?php echo $SelectModel[$i]->getModel(); ?>' <?php if($cmbmodel==$SelectModel[$i]->getModel()) {echo "selected";} ?> ><?php echo $SelectModel[$i]->getModel(); ?></option>
 ...
 <!--            <div class="form-group">
      ...
      <input type="text" class="form-control" id="Stextmodel" name="Stextmodel" value="ITIF" disabled >
    </div> -->
  ...
  <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                           <div class="row">
                            ...
                            <div class="col-md-9">
                            <input type="text" id="txtQuantity" name="txtQuantity" class="form-control input-sm" value="0" <?php echo $readonly; ?>><br>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                            <input type="text" id="txtModel" name="txtModel" value="<?php echo $cmbmodel?>" class="form-control input-sm"  <?php echo $readonly; ?>><br>
                            </div>
                            <div class="col-md-3">
                                <label>Type:</label>
                            </div>
      ...
      if (document.getElementById("StextChildSerial").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
              ...
              var txtpartno = $('input[name="txtchildpartno[]"]').map(function () {
            return this.value; }).get(); 

                   for(x=0;x<txtpartno.length;x++){
        
                        if(txtpartno[x] == res[3]){
                           proceed = false;   
                            alert("Child Model Already Exist in Table!");
          ...
          '</tr>');
             ...
             document.getElementById("StextChildSerial").focus();
                ...
                document.getElementById("StextChildSerial").select();
      ...
      if (document.getElementById("StextSerial").value == '') {     
          return;
            ...
            if (this.readyState == 4 && this.status == 200) {
              ...
              xmlhttp.open("GET", "../php/addmotherserialpt.php?serialno=" + document.getElementById("StextSerial").value +"&model="+ document.getElementById("ScmbModel").value + "&line=" + document.getElementById("ScmbLine").value + "&type=" + document.getElementById("Scmbtype").value+ "&quantity=" + document.getElementById("txtQuantity").value+"&txtChildSerial="+JSON.stringify(txtChildSerial)+"&txtchildstatus="+JSON.stringify(txtchildstatus)+"&txtchildpartno="+JSON.stringify(txtchildpartno), true);
            xmlhttp.send();
          }
