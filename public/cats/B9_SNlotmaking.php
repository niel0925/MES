 ...
 document.getElementById("Scmbpartcode").disabled = true;
        ...
        document.getElementById("RQuantity").select();
          ...
          if(keycode == '13'){
            ...
            xmlhttp.open("GET", "../php/B9_batchlotexist.php?model=" + document.getElementById("lottxtModel").value + "&lotno=" + document.getElementById("StextLotNo").value + "&station=" + document.getElementById("lottxtLocation").value+"&RQuantity=" + document.getElementById("RQuantity").value+"&partcode=" + document.getElementById("lottxtpartcode").value, true);
            xmlhttp.send();
          ...
          if(keycode == '13'){
            ...
            xmlhttp.open("GET", "../php/B9_lotserial.php?serialno=" + document.getElementById("StextSerial").value + "&model=" + document.getElementById("lottxtModel").value + "&station=" + document.getElementById("lottxtLocation").value, true);
            xmlhttp.send();
          ...
          $( "#btnGood" ).click(function() {
            ...
            xmlhttp.open("GET", "../php/B9_addserialtolot.php?serialno=" + document.getElementById("StextSerial").value+"&lotno="+ document.getElementById("StextLotNo").value +"&station=" + document.getElementById("lottxtLocation").value+"&RQuantity=" + document.getElementById("RQuantity").value +"&Quantity=" + document.getElementById("Totallotquantity").value+"&line=" + document.getElementById("ScmbLine").value+"&total=" + document.getElementById("TotalQuantity").value+"&reference=" + document.getElementById("StextReferenceno").value, true);
            xmlhttp.send();
           ...
           /*       document.getElementById("StextLotNo").disabled = false;
                  ...
                  document.getElementById("ScmbLine").focus();*/
                    ...
                    window.open('http://192.168.1.22:30/mes/print/B9_lotSN.php?lot='+document.getElementById("StextLotNo").value+'&ref='+document.getElementById("StextReferenceno").value+'&model='+document.getElementById("Stextmodel").value+'&partcode='+document.getElementById("lottxtpartcode").value+'&qty='+document.getElementById("LotQuantity").value)
...
document.getElementById("RQuantity").disabled = true;
            ...
            xmlhttp.open("GET", "../php/B9_lotclose.php?lotno="+ document.getElementById("StextLotNo").value +"&station=" + document.getElementById("lottxtLocation").value+"&partcode=" + document.getElementById("lottxtpartcode").value+"&LotQuantity=" + document.getElementById("LotQuantity").value+"&modelno="+ document.getElementById("lottxtModel").value+"&total=" + document.getElementById("TotalQuantity").value+"&reference=" + document.getElementById("StextReferenceno").value, true);
            xmlhttp.send();
